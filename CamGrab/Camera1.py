...
class Camera:
    ...
    def OpenDevice(self):
        ...
        current_device_info_1 = cast(self.device_list.pDeviceInfo[0], POINTER(MV_CC_DEVICE_INFO)).contents
        ...
        if ret != 0:
            ...
            self.log_queue.put(("open device successfully 1", "open device successfully 1"))
            print("open device successfully 1")
    ...
    def StartGrab(self):
        ...
        pub = ecal_core.publisher(f'defect_detection_topic_1')
