...
"")
        ...
        self.graphicsView_3.setMinimumSize(QSize(0, 0))
...
"font-size:17px;")
        ...
        sizePolicy7.setHeightForWidth(self.menu_2.sizePolicy().hasHeightForWidth())
        self.menu_2.setSizePolicy(sizePolicy7)
        self.menu_2.setMinimumSize(QSize(0, 0))
        self.menu_3 = QMenu(self.menubar)
        self.menu_3.setObjectName(u"menu_3")
        sizePolicy5.setHeightForWidth(self.menu_3.sizePolicy().hasHeightForWidth())
        self.menu_3.setSizePolicy(sizePolicy5)
        self.menu_3.setMinimumSize(QSize(0, 0))
        ...
        self.menu_2.addAction(self.actionOpen_Camera)
        self.menu_2.addAction(self.actionClose_Camera)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menu_2.setTitle(QCoreApplication.translate("MainWindow", u"\u63a7\u5236", None))
